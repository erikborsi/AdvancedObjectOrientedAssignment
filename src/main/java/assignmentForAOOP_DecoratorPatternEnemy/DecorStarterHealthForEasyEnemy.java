 ...
 * pizza
 */
public class DecorStarterHealthForEasyEnemy extends EnemyDecorator {

    Enemy enemy;

    public DecorStarterHealthForEasyEnemy(Enemy enemy) {
        this.enemy = enemy;
    }
    ...
    public double getHealthPointsOfEnemy() {
        return enemy.getHealthPointsOfEnemy() + 50;
